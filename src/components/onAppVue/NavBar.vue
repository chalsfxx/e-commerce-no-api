<template>
  <section class="userLinks">
    ...
    <router-link class="link" to="/joinus">Sign Up</router-link>|
  ...
  <nav class="navbar">
    ...
    <div class="brand">
      <router-link to="/">
        <!-- <h1 class="logo bg-info text-decoration-none">TECHY</h1> -->
        <img class=" img-fluid img-responsive  logo" src="@/assets/techylogo.jpg" alt="" /> 
      </router-link>
    </div>
    <div class="tools">
      <div class="dropdown">
